    ...
    <div class="mx-4 flex-auto max-md:mx-6 max-sm:mx-4">
        ...
        <div class="mt-8 grid grid-cols-1 gap-y-6 max-md:mt-5 max-sm:gap-y-4">
            @foreach ($attributes as $attribute)
                {!! view_render_event('bagisto.shop.customers.account.profile.{$attribute->code}.before') !!}
                ...
                {!! view_render_event('bagisto.shop.customers.account.profile.{$attribute->code}.after') !!}
            @endforeach
